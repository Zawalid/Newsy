...
import { useEmails } from '../_hooks/use-emails';
import { useEmailsSearchAndFilters } from '../_hooks/use-emails-search-filters';
...
export default function Inbox({ children, defaultLayout = [25, 75], placeholderData }: InboxProps) {
  ...
  const { emails, nextPageToken, isLoading, isFetching, invalidate } = useEmails(query, pageToken, placeholderData);
