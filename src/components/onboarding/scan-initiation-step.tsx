...
export function ScanInitiationStep({ onBack, onStartScan, onShowScanSettings }: ScanInitiationStepProps) {
  return (
      ...
      <div className='flex-1 text-center md:text-left'>
        ...
        >
          ...
          <p className='text-sm italic'>
            Remember, your privacy is our priority. We don&apos;t read or store your email content.
          </p>
        </motion.div>
        ...
        >
          <div className='flex flex-row-reverse rounded-xl border'>
            <Button
              className='peer rounded-s-none rounded-e-xl bg-transparent text-foreground hover:text-white'
            ...
            <Button
              onClick={onStartScan}
              className='rounded-s-xl rounded-e-none px-5 text-base peer-hover:text-foreground peer-hover:bg-transparent'
            >
              <Search className='mr-2 h-4 w-4' /> Start Scanning
            </Button>
          </div>

          <Button variant='outline' onClick={onBack} icon={ArrowLeft} iconPlacement='left'>
            Back
          </Button>
        </motion.div>
